...
def conectar_db():
    # PROGRAMACIÓN: Forzamos una ruta absoluta idéntica en la raíz del disco C:
    ruta_carpeta = r"C:\AppTickets"
...
with st.form("form_cliente", clear_on_submit=True):
    ...
    if boton_enviar:
        if cliente and descripcion:
            ...
            conn.close()
            st.success("¡Reporte guardado con éxito en C:\\AppTickets\\tickets.db!")
        else:
